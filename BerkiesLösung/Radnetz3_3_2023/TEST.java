...
class TEST
{
    ...
    TEST()
    {
            ...
            int z = radnetz.knotenHinzufuegen(new DATENELEMENT("Ziegelstein", 200, "Heimatmuseum"));
            int b = radnetz.knotenHinzufuegen(new DATENELEMENT("Burg", 50, "Historische Burg"));
            int n = radnetz.knotenHinzufuegen(new DATENELEMENT("Neustadt", 80, "Einkaufszentrum"));
            int r = radnetz.knotenHinzufuegen(new DATENELEMENT("Rain", 50, "Klettergarten"));
//         
    ...
    {
        radnetz.tiefensucheStarten(startKnoten);       
    }
